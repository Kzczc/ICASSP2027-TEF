...
from _report import base_parser, emit, markdown_table
...
def main() -> None:
    ...
    for model in args.models:
        ...
        for prompt in PROMPT_VARIANTS:
            averages = {m: [] for m in BASELINES + ("tef",)}
            for lang in args.lang:
                table = dimension_table(load_records(cache_path(args.output_dir, model, prompt, lang)), averages)
        ...
        rows.append([model] + baseline_cells + tef_cells)
